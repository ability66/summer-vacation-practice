...
public class CosineSimilarAlgorithm {
    ...
    public static Double cosSimilarityByFile(String firstFile, String secondFile, List<String> w) {
        try {
            Map<String, Map<String, Integer>> firstTfMap = TfIdfAlgorithm.wordSegCount(firstFile, w);
            Map<String, Map<String, Integer>> secondTfMap = TfIdfAlgorithm.wordSegCount(secondFile, w);
    ...
    public static List<DataVO> cosSimilarityByFiles(String firstFile, String secondFile, List<String> w) {
        try {
            List<Map<String, Object>> firstTfMap = TfIdfAlgorithm.wordSegCounts(firstFile, new ArrayList<>());
            List<Map<String, Object>> secondTfMap = TfIdfAlgorithm.wordSegCounts(secondFile, w);
    ...
    public static Double cosSimilarityByString(String first, String second, List<String> w) {
        try {
            Map<String, Integer> firstTfMap = TfIdfAlgorithm.segStr(first, w);
